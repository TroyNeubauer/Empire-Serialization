...
public class EmpireConstants {
	...
	public static final int PRIMITIVE_TYPE 			= 0b0 << 6;
	public static final int USER_DEFINED_TYPE 		= 0b1 << 6;

	public static final int TYPE_REF_TYPE 			= 0b0 << 7;
	public static final int TYPE_DEF_TYPE 			= 0b1 << 7;
	//format:on
