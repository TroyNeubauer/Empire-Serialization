...
public interface TroyIO extends Closeable {
	 ...
	 * will block until x bytes are available, or throw an {@link EndOfInputException} the end of stream is reached before x bytes are avilable.
	 * 
	 ...
	 * If the implemenentation of this IO doesn't use an internal buffer, this method does nothing. 
	 */
