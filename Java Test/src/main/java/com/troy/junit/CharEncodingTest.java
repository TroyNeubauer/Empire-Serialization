...
public class CharEncodingTest {
	...
	private static final byte[] SIX_BIT_RESULT = new byte[] { -27, 53, 30, 1, 71, -128, -87, -122, -44, 117, 0, 56, 65,
			-43, 12, 93, 73, 76, 125, 70, -103, 2, 39, 84, 125, -12, 25, 0, -39, 0, -27, -42, -92, 3, 52, 32, 52, -56,
			16, 7, 66 };
	
	private static final char[] VLE8_TEST = ("This is a test VLE8 String next char is scarry:" +'\u1969').toCharArray();
	...
	public void javaFourBit() {
		...
		ByteArrayOutput out = new ByteArrayOutput();
		EmpireCharsets.FOUR_BIT_CHARSET.encode(FOUR_BIT_TEST, out, 0, FOUR_BIT_TEST.length, StringInfo.ALL_ASCII);
		assertArrayEquals(Arrays.copyOf(out.getBuffer(), out.getBufferPosition()),
				new byte[] { 0b00010000, 0b01100001 });
	}
